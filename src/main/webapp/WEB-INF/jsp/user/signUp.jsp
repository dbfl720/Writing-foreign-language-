			...
			<div class="accounts_forms signup_form w-100 h-100" id="signup">
				...
				<form id="signUpForm" method="post" action="/user/sign_up"
					...
					<div class="row">
						...
						<div id="idCheckLength" class="duplicatedText text-danger d-none">Please
							enter at least 4 characters.</div>
						<div id="idCheckDuplicated"
							class="duplicatedText text-danger d-none">already Id in
							use.</div>
						<div id="idCheckOk" class="duplicatedText text-success d-none">It's
							possible to use.</div>
						...
						<div class="col col-sm-12 col-md-12 col-lg-12 m-0">
							<div class="form-group">
								<label for="signup_password">Password</label> <i
									...
									class="form-control signUpInputPadding" id="signup_password"
									onfocus="labelUp(this)" onblur="labelDown(this)" required />
							</div>
							<div class="form-group">
								<label for="cpass">Confirm Password</label> <input
									type="password" name="confirmPassword"
									class="form-control signUpInputPadding" id="confirmPassword"
									onfocus="labelUp(this)" onblur="labelDown(this)" required />
							</div>
							<div class="form-group">
							...
							<!--form-row-->
							<div class="form-group">
								<button id="signUpBtn" name="signUpBtn" type="button"
									class="btn btn-primary register_btn w-100">Sign Up</button>
							</div>
						</div>
					</div>
